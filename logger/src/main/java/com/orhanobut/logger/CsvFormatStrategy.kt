...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    private static final String NEW_LINE_REPLACEMENT = System.getProperty("line.separator");
    ...
    public static final class Builder {
        ...
        @NonNull
        public CsvFormatStrategy build(String fileName, String diskPath) {
            if (date == null) {
                date = new Date();
            }
            if (dateFormat == null) {
            ...
            if (logStrategy == null) {
                ...
                ht.start();
                Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), diskPath, fileName, MAX_BYTES);
